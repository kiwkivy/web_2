...
var snowStorm = function (g, f) {
    ...
    this.vMaxX = 5; //скорость падения
    this.vMaxY = 4;
    this.zIndex = 0;
    var a = this, q, m = navigator.userAgent.match(/msie/i), D = navigator.userAgent.match(/msie 6/i),
        C = navigator.userAgent.match(/mobile|opera m(ob|in)/i), r = m && "BackCompat" === f.compatMode || D, h = null,
        n = null, l = null, p = null, s = null, y = null, z = null, v = 1, t = !1, u;
    a:{
        try {
            f.createElement("div").style.opacity = "0.5" //прозрачность
        } catch (E) {
            u = !1;
            break a
        }
    ...
    var A = !1, B = f.createDocumentFragment();
    q = function () {
        function c(b) {
...
window.onload = function () {
    ...
    snowStorm.snowColor = "#6cf"; // Цвет снежинок
